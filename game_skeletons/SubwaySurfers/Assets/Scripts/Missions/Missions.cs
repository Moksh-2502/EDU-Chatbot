...
public abstract class MissionBase
{
    ...
    public virtual bool HaveProgressBar()
    {
        return true;
    }
...
public class PickupMission : MissionBase
{
    ...
    public override void Update(TrackManager manager)
    {
        int coins = IPlayerStateProvider.Instance.RunCoins - previousCoinAmount;
        progress += coins;

        previousCoinAmount = IPlayerStateProvider.Instance.RunCoins;
    }
}
...
public class BarrierJumpMission : MissionBase
{
    ...
    public override void Update(TrackManager manager)
    {
        ...
        {
            Vector3 boxSize = manager.characterController.characterCollider.collider.size +
...
public class MultiplierMission : MissionBase
{
    ...
    public override void Update(TrackManager manager)
    {
        progress = IPlayerStateProvider.Instance.GetTotalMultiplier();
    }
}