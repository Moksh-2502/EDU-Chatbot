...
public class SettingPopup : MonoBehaviour
{
    ...
    public void MasterVolumeChangeValue(float value)
    {
        ...
        IPlayerDataProvider.Instance.SaveVolumeAsync(k_MasterVolumeFloatName, m_MasterVolume);
    }
    ...
    public void MusicVolumeChangeValue(float value)
    {
        ...
        IPlayerDataProvider.Instance.SaveVolumeAsync(k_MusicVolumeFloatName, m_MusicVolume);
    }
    ...
    public void MasterSFXVolumeChangeValue(float value)
    {
        ...
        IPlayerDataProvider.Instance.SaveVolumeAsync(k_MasterSFXVolumeFloatName, m_MasterSFXVolume);
    }
}
